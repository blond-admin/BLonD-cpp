...
int main(int argc, char** argv) {
    ...
    // N_t = atoi(util::GETENV("N_TURNS")) ? atoi(util::GETENV("N_TURNS")) :
    // N_t;
    // N_p = atoi(util::GETENV("N_PARTICLES")) ?
    // atoi(util::GETENV("N_PARTICLES")) : N_p;
    // N_slices = atoi(util::GETENV("N_SLICES")) ?
    // atoi(util::GETENV("N_SLICES")) : N_slices;
    // n_threads =
