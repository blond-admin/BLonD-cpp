...
util::read_vector_from_file(v, statistics_params
+ "sigma_dE");
ftype ref = v[0];
...
std::vector<ftype> v;
util::read_vector_from_file(v, long_cut_params
+ "id");
for (
unsigned int i = 0;
i<v.
...
std::vector<ftype> v;
util::read_vector_from_file(v, energy_cut_params
+ "id");
for (
unsigned int i = 0;
i<v.
