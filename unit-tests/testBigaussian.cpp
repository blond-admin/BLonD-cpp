...
{
    std::string params = TEST_FILES "/Bigaussian/sigmas1/";
    auto epsilon = 1e-8;
...
{
    std::string params = TEST_FILES "/Bigaussian/dE1/";
...
{
    std::string params = TEST_FILES "/Bigaussian/dE2/";
...
TEST_F(testBigaussian, dt1)
{
    ...
    std::string params = TEST_FILES "/Bigaussian/dt1/";
...
TEST_F(testBigaussian2, dE3)
{
    ...
    std::string params = TEST_FILES "/Bigaussian/dE3/";
...
TEST_F(testBigaussian2, dt2)
{
    ...
    std::string params = TEST_FILES "/Bigaussian/dt2/";
